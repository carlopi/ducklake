...
build_duckdb_side_repo: setup_duckdb_side_repo
	cd build_extra/duckdb && USE_MERGED_VCPKG_MANIFEST=1 VCPKG_TOOLCHAIN_PATH=${VCPKG_ROOT}/scripts/buildsystems/vcpkg.cmake CORE_EXTENSIONS="ducklake;${EXTRA_EXTENSIONS}" make
